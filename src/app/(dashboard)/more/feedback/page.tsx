  ...
  return (
    <div className="pb-24 font-sans">
      <div className="mb-8 flex items-center gap-4">
        ...
        <div>
          <h1 className="text-4xl font-heading font-bold text-[var(--foreground)] tracking-tight">Feedback</h1>
          <p className="text-[var(--muted-foreground)] text-sm font-medium">We&apos;d love to hear from you.</p>
        </div>
      </div>
